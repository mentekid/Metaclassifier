...
entropyRfc_bias = RandomForestClassifier(n_estimators=100, min_samples_split=2, n_jobs=-1, criterion='entropy', class_weight=cw)


ensemble = [knn1, knn2, entropyTree, entropyRfc, svm, entropyRfc_bias]
...
agg_names = ['Log. Reg. 1:2', 'Gaussian NB', 'Decision Tree', 'kNN', 'SVM', 'voting']
